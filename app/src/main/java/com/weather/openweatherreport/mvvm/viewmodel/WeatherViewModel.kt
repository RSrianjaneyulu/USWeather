package com.weather.openweatherreport.mvvm.viewmodel
...
import com.weather.openweatherreport.mvvm.repository.WeatherRetrofitInstance
...
class WeatherViewModel @Inject constructor(private val weatherRepository: WeatherRepository): ViewModel() {
    ...
    var weatherList = MutableLiveData<CommonWeather>()
    var job: Job? = null
    ...
    fun getWeatherReport(cityName: String, appid: String) {
        job = CoroutineScope(Dispatchers.IO + coroutineExceptionHandler).launch {
            val response = weatherRepository.getWeatherReport(cityName, appid)
