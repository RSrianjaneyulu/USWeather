...
import com.weather.openweatherreport.databinding.ItemWeatherAdapterBinding
            ...
            if (weatherData != null) {
                ...
                if (weatherData.get(position).dt != null) {
                    ...
                    if (StringUtils.isNotEmpty(currentDateTime)) {
                        holder.binding.tvIWACurrentDateAndTime.setText(
                            Helper.convertUnixTimeToDateMonth(
                                currentDateTime
                            )
                        )
                    } else {
